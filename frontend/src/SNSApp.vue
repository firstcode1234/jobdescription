            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    <v-list-item
                        class="px-2"
                        key="jobdescriptions"
                        to="/allDepartments/jobdescriptions"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="organizations"
                        to="/innovationStrategyDepartments/organizations"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                ...
                description: '', 
                key: 'jobdescriptions', 
                route: '/allDepartments/jobdescriptions',
                ImageUrl: '',
            },
            { 
                title: 'Organization', 
                description: '', 
                key: 'organizations', 
                route: '/innovationStrategyDepartments/organizations',
                ImageUrl: '',
            },
            { 
                title: 'Employee', 
                description: '', 
                key: 'employees', 
                route: '/personnelOffices/employees',
                ImageUrl: '',
            },
